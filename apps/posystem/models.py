...
class ProductManager(models.Manager):
    ...
    def createProduct(self, postData):
        ...
        user = Product.objects.create(
            product_quantity=quantity, product_number=postData['product_number'], product_description=postData['product_description'], unit_cost=unitcost, final_cost=(quantity*unitcost), votes=0, status='5 Votes Needed')
        return user
...
class VendorManager(models.Manager):
    ...
    def createVendor(self, postData):
        user = Vendor.objects.create(
            vendor_name=postData['vendor_name'],vendor_address=postData['vendor_address'],vendor_city=postData['vendor_city'],vendor_state=postData['vendor_state'],vendor_zip=postData['vendor_zip'],vendor_phone=postData['vendor_phone'],vendor_fax=postData['vendor_fax'],)
        return user
